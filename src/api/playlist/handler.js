...
class PlaylistHandler {
    ...
    async postPlaylistHandler(request, h) {
        try {
            ...
            const response = h.response({
                status: success,
                message: statusMessage.addPlaylistSuccess,
                data: {
                    playlistId,
                },
            });
    ...
    async deletePlaylistByIdHandler(request, h) {
        try {
            ...
            return {
                status: success,
                message: statusMessage.playlistDeleted,
            };
        } catch (error) {
            if (error instanceof ClientError) {
                const response = h.response({
    ...
    async postSongHandler(request, h) {
        try {
            ...
            const response = h.response({
                status: success,
                message: statusMessage.songAddPlaylistSuccess,
            });
    ...
    async deleteSongByIdHandler(request, h) {
        try {
            ...
            return {
                status: success,
                message: statusMessage.songDeletedFromPlaylist,
            };
        } catch (error) {
            if (error instanceof ClientError) {
                const response = h.response({
